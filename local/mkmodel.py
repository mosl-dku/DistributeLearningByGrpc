...
class makemodel:
    ...
    def base_model(input_data):
        ...
        model.add(Dropout(0.1, name='laye:r2'))
    ...
    def test_base(input_data):
        model = Sequential()
        model.add(Dense(128, input_shape=[input_data.shape[1]],activation='sigmoid',name='layer1'))
        #model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer2'))
        model.add(Dense(64,activation='sigmoid', name='layer3'))
        #model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer4'))
        model.add(Dense(16,activation='sigmoid', name='layer5'))
        #model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer6'))
        model.add(Dense(2,activation='sigmoid',name='layer7'))
        #model.add(LeakyReLU(alpha=0.01))
        model.add(Dense(1, name='final_layer'))
                
        return mode

    def test_base_2(input_data):
        model = Sequential()
        model.add(Dense(128, input_shape=[input_data.shape[1]],activation='sigmoid',name='layer1'))
        #model.add(Sigmoid(alpha=0.01))
        model.add(Dropout(0.1, name='layer2'))
        model.add(Dense(64, activation='sigmoid',name='layer3'))
        #model.add(Sigmoid(alpha=0.01))
        model.add(Dropout(0.1, name='layer4'))
