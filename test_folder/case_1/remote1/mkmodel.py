...
class makemodel:
    ...
    def test_layer2(input_data):
        model = Sequential()
        model.add(Dense(256, input_shape=[input_data.shape[1]],kernel_initializer='he_normal', name='layer1'))
        model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer2'))
        model.add(Dense(128, kernel_initializer='he_normal', name='layer3'))
        model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer4'))

        return model

    def test_layer22(input_data):
        model = Sequential()
    ...
    def test_base(input_data):
        model = Sequential()
        model.add(Dense(256, input_shape=[input_data.shape[1]],kernel_initializer='he_normal', name='layer0'))
        model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer01'))
        model.add(Dense(128,kernel_initializer='he_normal', name='layer1'))
        model.add(LeakyReLU(alpha=0.01))
        model.add(Dropout(0.1, name='layer2'))
