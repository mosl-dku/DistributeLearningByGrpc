...
if __name__ == '__main__':
        ...
        merged_x_train = np.concatenate([x_train1_passed, x_train2_passed], axis=0)#, x_train3_passed, x_train4_passed, x_train5_passed, x_train6_passed, x_train7_passed, x_train8_passed, x_train9_passed, x_train10_passed], axis=0)
        
        merged_y_train = np.concatenate([y_train1, y_train2], axis=0)#, y_train3, y_train4, y_train5, y_train6, y_train7, y_train8, y_train9, y_train10],axis=0)
        merged_y_train = pd.Series(merged_y_train, name='LDL-C') 
        merged_y_train = merged_y_train.astype(int)


        test_L1out = makemodel.test_base(merged_x_train)
